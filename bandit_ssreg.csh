...
#       -xjpeg ${id}_basic_design.png 
   ...
   #Do a no data run to look at reward, value, and PEchosen
#   /usr/local/ni_tools/afni/3dDeconvolve \
#    -nodata 200 1 \
#    -num_stimts 3 \
#    -stim_times_FSL 1 "${regpath}/${id}valueDecisionAligned_chosen_diff.dat" 'dmUBLOCK' -stim_label 1 valueChosenDiffDecAligned \
#    -stim_times_FSL 2 "${regpath}/${id}chosenPEs.dat" 'dmUBLOCK' -stim_label 2 PEChosen \
#    -stim_times_FSL 3 "${regpath}/${id}reward_trial_stake.dat" 'dmUBLOCK' -stim_label 3 rewardTrialStake \
#    -censor "${regpath}/bandit${id}_motion_censor" \
#    -nlast 200 -polort 0 -fout -rout -full_first \
#    -x1D stdout: | 1dplot -stdin -one -thick -ynames null valueChosenDiffDecAigned PEchosen Reward \ 
