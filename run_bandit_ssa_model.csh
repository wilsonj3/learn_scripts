...
set out_dir = "working_models/new_PE"
#set out_dir = "error_dump"
...
#       -censor "${regpath}/bandit${id}_motion_censor" \
#       -polort 12 -fout -rout -full_first \
#       -bucket banditDecFeedValueChosenDiffStakeDecFeedPEChosenSigned_${id} \
#       -xjpeg ${id}_basic_design.png 
...
#       -stim_times_FSL 4 "${regpath}/${id}stakeFeedbackAligned.dat" 'dmUBLOCK' -stim_label 4 StakeFeedAligned \
#       -stim_times_FSL 5 "${regpath}/${id}valueDecisionAligned_chosen_diff.dat" 'dmUBLOCK' -stim_label 5 valueChosenDiffDecAligned \
#       -stim_times_FSL 6 "${regpath}/${id}chosenPosPEs.dat" 'dmUBLOCK' -stim_label 6 PEChosenPositive \
#       -stim_times_FSL 7 "${regpath}/${id}chosenNegPEs.dat" 'dmUBLOCK' -stim_label 7 PEChosenNegative \
#       -stim_times_FSL 8 "${regpath}/${id}left.dat" 'dmUBLOCK' -stim_label 8 left \
#       -censor "${regpath}/bandit${id}_motion_censor" \
#       -polort 12 -fout -rout -full_first \
#       -bucket banditDecFeedValueChosenDiffStakeDecFeedPEChosenPosNeg_${id} \
#       -xjpeg ${id}_basic_design.png 
       
       
#       #4-06-2016
#       #Censoring no reward trials taking out PEchosen-
#       /usr/local/ni_tools/afni/3dDeconvolve \
#      -input ${funcpath}/*bandit1*/nf*$func_name*.nii.gz \
#             ${funcpath}/*bandit2*/nf*$func_name*.nii.gz \
#             ${funcpath}/*bandit3*/nf*$func_name*.nii.gz \
...
#       -censor "${regpath}/bandit${id}_motion_censor" \
#       -polort 12 -fout -rout -full_first \
#       -bucket banditNoRewardCensored_${id} \
#       -xjpeg ${id}_basic_design.png 
       
#       #4-06-2016
#       #Adding in rew Mag with PEChosen +/- THE ONE USED FOR INITAL ANALYSIS!
#       /usr/local/ni_tools/afni/3dDeconvolve \
#      -input ${funcpath}/*bandit1*/nf*$func_name*.nii.gz \
#             ${funcpath}/*bandit2*/nf*$func_name*.nii.gz \
#             ${funcpath}/*bandit3*/nf*$func_name*.nii.gz \
...
#       -stim_times_FSL 2 "${regpath}/${id}feedback_Times.dat" 'dmUBLOCK' -stim_label 2 feedback \
#       -stim_times_FSL 3 "${regpath}/${id}stakeDecisionAligned.dat" 'dmUBLOCK' -stim_label 3 StakeDecAligned \
#       -stim_times_FSL 4 "${regpath}/${id}rewardMagnitudeFeedbackAligned.dat" 'dmUBLOCK' -stim_label 4 RewardMagnitude \
#       -stim_times_FSL 5 "${regpath}/${id}valueDecisionAligned_chosen_diff.dat" 'dmUBLOCK' -stim_label 5 valueChosenDiffDecAligned \
#       -stim_times_FSL 6 "${regpath}/${id}chosenPEs.dat" 'dmUBLOCK' -stim_label 6 PEChosen \
#       -stim_times_FSL 7 "${regpath}/${id}left.dat" 'dmUBLOCK' -stim_label 7 left \
#       -censor "${regpath}/bandit${id}_motion_censor" \
#       -polort 12 -fout -rout -full_first \
#       -bucket banditStakeValueRewMagPEChosen_${id} \
#       -xjpeg ${id}_basic_design.png 
...
#       -stim_times_FSL 3 "${regpath}/${id}stakeDecisionAligned.dat" 'dmUBLOCK' -stim_label 3 StakeDecAligned \
#       -stim_times_FSL 4 "${regpath}/${id}rewardMagnitudeFeedbackAligned.dat" 'dmUBLOCK' -stim_label 4 RewardMagnitude \
#       -stim_times_FSL 5 "${regpath}/${id}valueDecisionAligned_chosen_diff_standardized.dat" 'dmUBLOCK' -stim_label 5 valueChosenDiffDecAligned_Zscored \
#       -stim_times_FSL 6 "${regpath}/${id}chosenPEs_standardized.dat" 'dmUBLOCK' -stim_label 6 PEChosen_Zscored \
#       -stim_times_FSL 7 "${regpath}/${id}left.dat" 'dmUBLOCK' -stim_label 7 left \
#       -censor "${regpath}/bandit${id}_motion_censor" \
#       -polort 12 -fout -rout -full_first \
#       -bucket banditStakeValueRewMagPEChosen_${id}_Zscored \
#       -xjpeg ${id}_basic_design.png 
       
       
       #4/29/2016
       #New_PE + Zscored value diff
       /usr/local/ni_tools/afni/3dDeconvolve \
      -input ${funcpath}/*bandit1*/nf*$func_name*.nii.gz \
             ${funcpath}/*bandit2*/nf*$func_name*.nii.gz \
             ${funcpath}/*bandit3*/nf*$func_name*.nii.gz \
       ...
       -stim_times_FSL 3 "${regpath}/${id}stakeDecisionAligned.dat" 'dmUBLOCK' -stim_label 3 StakeDecAligned \
       -stim_times_FSL 4 "${regpath}/${id}rewardMagnitudeFeedbackAligned.dat" 'dmUBLOCK' -stim_label 4 RewardMagnitude \
       -stim_times_FSL 5 "${regpath}/${id}valueDecisionAligned_chosen_diff_standardized.dat" 'dmUBLOCK' -stim_label 5 valueChosenDiffDecAligned_Zscore \
       -stim_times_FSL 6 "${regpath}/${id}chosenPEs.dat" 'dmUBLOCK' -stim_label 6 PEChosen \
       -stim_times_FSL 7 "${regpath}/${id}left.dat" 'dmUBLOCK' -stim_label 7 left \
       -censor "${regpath}/bandit${id}_motion_censor" \
       -polort 12 -fout -rout -full_first \
       -bucket banditStakeValueRewMagHiddenStatePEChosen_${id} \
       -xjpeg ${id}_basic_design.png 
